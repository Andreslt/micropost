...
clear
rails s
rails d scaffold Evento
rails g scaffold Evento
rails d scaffold Evento
rails g scaffold Evento nombre:string tipo:string fecha:date barrio:references ubicacion:string asistentes:int hora:time descripcion:text
rails s
clear
rails s
clear
...
clear
git log
git checkout e780ab8fb152523a7cdb8c5474a3b0d4b79bc365
git checkout master
git stash
git log
git checkout  e780ab8fb152523a7cdb8c5474a3b0d4b79bc365
...
git status
git checkout development
git commit -m "Updated 02/05/2014"
git merge master
git checkout master
git merge development
git status
